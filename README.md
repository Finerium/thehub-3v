...
Fixture: harness 1.1.0, bundle `1.0.3`, recipe `a16e70cf22ae`. Regenerate with `pnpm readme:numbers --write`; `pnpm readme:numbers` fails the build when this table or a figure in the prose differs from the data.
<!-- numbers:end -->
