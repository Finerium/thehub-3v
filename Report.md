...
| AC-FND-06 | TAG | deviation | `gitleaks git --no-banner on each of the three repositories; git tag --list in each; ls LICENSE CHANGELOG.md...` | gitleaks 8.30.1 today: no leaks found on all three full histories (thehub-3v 10.56 MB, thehub-harness 2.75 MB, thehub-corpus 336 KB). thehub-3v still carries NO tag at all; thehub-harness carries v1.0.0 to v1.0.6... |
